...
const BALLOON_REVEAL_PHOTO = 'data:image/jpeg;base64,';
              ...
              {showBalloonPhoto && (
                <div className="absolute" style={{ left: '50%', top: '50%', animation: 'photoRevealIn 0.7s ease-out both', pointerEvents: 'none' }}>
                  <div className="relative">
                    {/* 은은하게 숨쉬는 글로우 */}
                    <div style={{ position: 'absolute', inset: -20, borderRadius: 36, background: 'radial-gradient(circle, rgba(255,213,74,0.5) 0%, rgba(255,213,74,0) 72%)', animation: 'photoGlowPulse 2.6s ease-in-out infinite', zIndex: -1 }} />
                    ...
                    {[
                      ...
                      <span key={i} style={{ position: 'absolute', left: s.x, top: s.y, fontSize: 13, color: '#FFE38A', textShadow: '0 0 6px rgba(255,213,74,0.9)', animation: `sparkleTwinkle 1.8s ease-in-out ${s.d}s infinite` }}>✦</span>
                    ))}
                  </div>
                </div>
              )}
